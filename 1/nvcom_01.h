...
#define	OR_VPIN_Ch		*((volatile int *)0xb82F880Ñ)
...
#define	OR_VPOUT_Ch		*((volatile int *)0xb82F980Ñ)
...
#define	OR_EMACC_h0		*((volatile int *)0xb82FE80Ñ)
...
#define	OR_EMAC_Ch1		*((volatile int *)0xb82FE84Ñ)
...
#define	OR_USB_Ch0		*((volatile int *)0xb82FC80Ñ)
...
#define	OR_USB_Ch1		*((volatile int *)0xb82FC84Ñ)
...
#define	OR_USB_Ch2		*((volatile int *)0xb82FC88Ñ)
...
#define	VENDOR_INDEX_USB	*((volatile int *)0xb82FC00Ñ)
...
#define	REVISION_USB		*((volatile int *)0xb82FC01Ñ)
...
#define	CSR_EP4_USB		*((volatile int *)0xb82FC02Ñ)
...
#define	UCADDR_H		*((volatile int *)0xb82FE02Ñ)
...
#define	MCADDR_MASK_H		*((volatile int *)0xb82FE03Ñ)
...
#define	RX_FR_MaxSize		*((volatile int *)0xb82FE04Ñ)
...
#define dbPCd(i)	        *((volatile int *) (BASE(i)+0x052Ñ))
...
#define dbSAR(i)	        *((volatile int *) (BASE(i)+0x053Ñ))
...
#define dbSAR7(i)	        *((volatile int *) (BASE(i)+0x055Ñ))
